Public Class 第三關
    ...
    Dim t(30) As Integer 'timer陣列
    Dim win As Integer = 0
    Dim i, c(7) As Integer
    Dim Fblood(19) As Label
    Dim FDtag(19) As Integer
    Dim FD(23) As Integer
    Dim bang(7) As Integer '殭屍有沒有撞到
    ...
    Dim die(7) As Integer '已死掉
    Dim number As Integer '第幾隻殭屍要死掉
    Dim zblood(7) As Integer '殭屍血量
    Dim zbloodLB(7) As Label '殭屍血量label
    Dim pic(19) As PictureBox '選擇放置位子的框框
    Dim zombie(7) As PictureBox '殭屍
    ...
    Private Sub 第三關_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        moneyLB.Text = 50
        ...
        AxWindowsMediaPlayer1.URL = Application.StartupPath & "\sounds\gameplay3.mp3"
        Randomize()
        i = 0
...
#End Region
        ...
        For j = 0 To 7
            ...
            'ElseIf j = 1 Or j = 5 Or j = 6 Then
            '    zombie(j).Image = My.Resources.青椒
            'End If
...
#Region "選擇格子位置"
    Private Sub PictureBox_MouseClick(sender As System.Object, e As MouseEventArgs) Handles PictureBox1.MouseClick, PictureBox2.MouseClick, PictureBox3.MouseClick, PictureBox4.MouseClick, PictureBox5.MouseClick, PictureBox6.MouseClick, PictureBox7.MouseClick, PictureBox8.MouseClick, PictureBox9.MouseClick, PictureBox10.MouseClick, PictureBox11.MouseClick, PictureBox12.MouseClick, PictureBox13.MouseClick, PictureBox14.MouseClick, PictureBox15.MouseClick, PictureBox16.MouseClick, PictureBox17.MouseClick, PictureBox18.MouseClick, PictureBox19.MouseClick, PictureBox20.MouseClick
        ...
        ElseIf foodchoose = 2 Then
            ...
            bullet(i).Image = My.Resources.射泡泡
            bullet(i).Width = 25
            bullet(i).Height = 25
...
#Region "殭屍前進且碰食物暫停"
    ...
    Private Sub ZW2_Tick(sender As Object, e As EventArgs) Handles ZW2.Tick
        ...
        For k = 0 To i - 1 ' Step -1
            If (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(1).Left And newfood(nownum(k)).Tag = 41 And zombie(1).Tag < 1) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(1).Left And newfood(nownum(k)).Tag = 42 And zombie(1).Tag < 2) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(1).Left And newfood(nownum(k)).Tag = 43 And zombie(1).Tag < 3) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(1).Left And newfood(nownum(k)).Tag = 44 And zombie(1).Tag < 4) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(1).Left And newfood(nownum(k)).Tag = 45 And zombie(1).Tag < 5) Then
                ...
                Z2.Enabled = False
                zombie(1).Image = My.Resources.青椒吃_300_
                '解決FD不夠問題
                If FD(1) <> 0 Then
                ...
                Else
                    FDtag(FD(17)) = newfood(nownum(k)).Tag
                End If
                '
                Z2eat.Enabled = True
                bang(1) = 1 '殭屍撞到
    ...
    Private Sub ZW3_Tick(sender As Object, e As EventArgs) Handles ZW3.Tick
        For k = 0 To i - 1 ' Step -1
            If (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(2).Left And newfood(nownum(k)).Tag = 31 And zombie(2).Tag < 1) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(2).Left And newfood(nownum(k)).Tag = 32 And zombie(2).Tag < 2) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(2).Left And newfood(nownum(k)).Tag = 33 And zombie(2).Tag < 3) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(2).Left And newfood(nownum(k)).Tag = 34 And zombie(2).Tag < 4) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(2).Left And newfood(nownum(k)).Tag = 35 And zombie(2).Tag < 5) Then
                ...
                Else
                    FDtag(FD(18)) = newfood(nownum(k)).Tag
                End If
                '
                Z3eat.Enabled = True
                bang(2) = 1 '殭屍撞到
            ElseIf bang(2) = 0 And zombie(2).Left > 0 Then '沒撞過的就是<>7
                If zombie(2).Left < pic(10).Left + pic(10).Width + 30 And pic(10).Tag = 35 And zombie(2).Tag < 5 Then
                    zombie(2).Tag += 1
                End If
                If zombie(2).Left < pic(11).Left + pic(11).Width + 30 And pic(11).Tag = 34 And zombie(2).Tag < 4 Then
                    zombie(2).Tag += 1
                End If
                If zombie(2).Left < pic(12).Left + pic(12).Width + 30 And pic(12).Tag = 33 And zombie(2).Tag < 3 Then
                    zombie(2).Tag += 1
                End If
                If zombie(2).Left < pic(13).Left + pic(13).Width + 30 And pic(13).Tag = 32 And zombie(2).Tag < 2 Then
                    zombie(2).Tag += 1
                End If
    ...
    Private Sub ZW4_Tick(sender As Object, e As EventArgs) Handles ZW4.Tick
        For k = 0 To i - 1 ' Step -1
            If (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(3).Left And newfood(nownum(k)).Tag = 11 And zombie(3).Tag < 1) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(3).Left And newfood(nownum(k)).Tag = 12 And zombie(3).Tag < 2) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(3).Left And newfood(nownum(k)).Tag = 13 And zombie(3).Tag < 3) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(3).Left And newfood(nownum(k)).Tag = 14 And zombie(3).Tag < 4) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(3).Left And newfood(nownum(k)).Tag = 15 And zombie(3).Tag < 5) Then
                ...
                Else
                    FDtag(FD(19)) = newfood(nownum(k)).Tag
                End If
                '
                Z4eat.Enabled = True
                bang(3) = 1 '殭屍撞到
            ElseIf bang(3) = 0 And zombie(3).Left > 0 Then '沒撞過的就是<>7
                If zombie(3).Left < pic(4).Left + pic(4).Width + 30 And pic(4).Tag = 11 And zombie(3).Tag < 1 Then
                    zombie(3).Tag += 1
                End If
                If zombie(3).Left < pic(3).Left + pic(3).Width + 30 And pic(3).Tag = 12 And zombie(3).Tag < 2 Then
                    zombie(3).Tag += 1
                End If
                If zombie(3).Left < pic(2).Left + pic(2).Width + 30 And pic(2).Tag = 13 And zombie(3).Tag < 3 Then
                    zombie(3).Tag += 1
                End If
                If zombie(3).Left < pic(1).Left + pic(1).Width + 30 And pic(1).Tag = 14 And zombie(3).Tag < 4 Then
                    zombie(3).Tag += 1
                End If
                If zombie(3).Left < pic(0).Left + pic(0).Width + 30 And pic(0).Tag = 15 And zombie(3).Tag < 5 Then
                    zombie(3).Tag += 1
                End If
                If zw(3) = 0 Then
    ...
    Private Sub ZW5_Tick(sender As Object, e As EventArgs) Handles ZW5.Tick
        ...
        For k = 0 To i - 1 ' Step -1
            If (die(4) = 0 And newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(4).Left And newfood(nownum(k)).Tag = 21 And zombie(4).Tag < 1) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(4).Left And newfood(nownum(k)).Tag = 22 And zombie(4).Tag < 2) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(4).Left And newfood(nownum(k)).Tag = 23 And zombie(4).Tag < 3) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(4).Left And newfood(nownum(k)).Tag = 24 And zombie(4).Tag < 4) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(4).Left And newfood(nownum(k)).Tag = 25 And zombie(4).Tag < 5) Then
                ...
                Z5.Enabled = False
                zombie(4).Image = My.Resources.茄子吃
                '解決FD不夠問題
                If FD(4) <> 0 Then
                    FDtag(FD(4)) = newfood(nownum(k)).Tag
                ElseIf FD(12) <> 0 Then
                    FDtag(FD(12)) = newfood(nownum(k)).Tag
                Else
                    FDtag(FD(20)) = newfood(nownum(k)).Tag
                End If
                '
                Z5eat.Enabled = True
                bang(4) = 1 '殭屍撞到
            ElseIf bang(4) = 0 And zombie(4).Left > 0 Then '沒撞過的就是<>7
                If zombie(4).Left < pic(9).Left + pic(9).Width + 30 And pic(9).Tag = 21 And zombie(4).Tag < 1 Then
                    zombie(4).Tag += 1
                End If
                If zombie(4).Left < pic(8).Left + pic(8).Width + 30 And pic(8).Tag = 22 And zombie(4).Tag < 2 Then
                    zombie(4).Tag += 1
                End If
                If zombie(4).Left < pic(7).Left + pic(7).Width + 30 And pic(7).Tag = 23 And zombie(4).Tag < 3 Then
                    zombie(4).Tag += 1
                End If
                If zombie(4).Left < pic(6).Left + pic(6).Width + 30 And pic(6).Tag = 24 And zombie(4).Tag < 4 Then
                    zombie(4).Tag += 1
                End If
                If zombie(4).Left < pic(5).Left + pic(5).Width + 30 And pic(5).Tag = 25 And zombie(4).Tag < 5 Then
                    zombie(4).Tag += 1
                End If
                If zw(4) = 0 Then
    ...
    Private Sub ZW6_Tick(sender As Object, e As EventArgs) Handles ZW6.Tick
        For k = 0 To i - 1 ' Step -1
            If (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(5).Left And newfood(nownum(k)).Tag = 31 And zombie(5).Tag < 1) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(5).Left And newfood(nownum(k)).Tag = 32 And zombie(5).Tag < 2) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(5).Left And newfood(nownum(k)).Tag = 33 And zombie(5).Tag < 3) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(5).Left And newfood(nownum(k)).Tag = 34 And zombie(5).Tag < 4) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(5).Left And newfood(nownum(k)).Tag = 35 And zombie(5).Tag < 5) Then
                ...
                Z6.Enabled = False
                zombie(5).Image = My.Resources.青椒吃_300_
                '解決FD不夠問題
                If FD(5) <> 0 Then
                    FDtag(FD(5)) = newfood(nownum(k)).Tag
                ElseIf FD(13) <> 0 Then
                    FDtag(FD(13)) = newfood(nownum(k)).Tag
                Else
                    FDtag(FD(21)) = newfood(nownum(k)).Tag
                End If
                '                
                Z6eat.Enabled = True
                bang(5) = 1 '殭屍撞到
    ...
    End Sub
    Private Sub ZW7_Tick(sender As Object, e As EventArgs) Handles ZW7.Tick

        For k = 0 To i - 1 ' Step -1
            If (die(6) = 0 And newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(6).Left And newfood(nownum(k)).Tag = 21 And zombie(6).Tag < 1) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(6).Left And newfood(nownum(k)).Tag = 22 And zombie(6).Tag < 2) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(6).Left And newfood(nownum(k)).Tag = 23 And zombie(6).Tag < 3) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(6).Left And newfood(nownum(k)).Tag = 24 And zombie(6).Tag < 4) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(6).Left And newfood(nownum(k)).Tag = 25 And zombie(6).Tag < 5) Then
                zombie(6).Left = newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30
                zbloodLB(6).Left = newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30
                Z7.Enabled = False
                zombie(6).Image = My.Resources.青椒吃_300_
                '解決FD不夠問題
                If FD(6) <> 0 Then
                    FDtag(FD(6)) = newfood(nownum(k)).Tag
                ElseIf FD(14) <> 0 Then
                    FDtag(FD(14)) = newfood(nownum(k)).Tag
                Else
                    FDtag(FD(22)) = newfood(nownum(k)).Tag
                End If
                '
                Z7eat.Enabled = True
                bang(6) = 1 '殭屍撞到
            ElseIf bang(6) = 0 And zombie(6).Left > 0 Then '沒撞過的就是<>7
                If zombie(6).Left < pic(9).Left + pic(9).Width + 30 And pic(9).Tag = 21 And zombie(6).Tag < 1 Then
                    zombie(6).Tag += 1
                End If
                If zombie(6).Left < pic(8).Left + pic(8).Width + 30 And pic(8).Tag = 22 And zombie(6).Tag < 2 Then
                    zombie(6).Tag += 1
                End If
                If zombie(6).Left < pic(7).Left + pic(7).Width + 30 And pic(7).Tag = 23 And zombie(6).Tag < 3 Then
                    zombie(6).Tag += 1
                End If
                If zombie(6).Left < pic(6).Left + pic(6).Width + 30 And pic(6).Tag = 24 And zombie(6).Tag < 4 Then
                    zombie(6).Tag += 1
                End If
                If zombie(6).Left < pic(5).Left + pic(5).Width + 30 And pic(5).Tag = 25 And zombie(6).Tag < 5 Then
                    zombie(6).Tag += 1
                End If
                If zw(6) = 0 Then
                    zombie(6).Left = zombie(6).Left - 3
                    zbloodLB(6).Left = zbloodLB(6).Left - 3
                End If
                zw(6) = 1
                If k = i - 1 Then
                    zw(6) = 0
                ...
                If zombie(6).Left <= 0 Then '碰邊界減一命
                    heart = heart - 1
                    'heartLB.Text = heart
                    zombie(6).Size = New Size(0, 0)
                    If heart = 0 Then
                        yesno = MsgBox("你輸了!請回主選單!", , "訊息")
                        'If yesno = 6 Then
                        '    Dim frm1 = New Form1
            ...
            End If
        Next
        If i = 0 And zombie(6).Left > 0 Then '解決k第一次不能跑的問題
            zombie(6).Left = zombie(6).Left - 3
            zbloodLB(6).Left = zbloodLB(6).Left - 3
            If zombie(6).Left < pic(9).Left + pic(9).Width + 30 And pic(9).Tag = 21 And zombie(6).Tag < 1 Then
                zombie(6).Tag += 1
    ...
    End Sub
    Private Sub ZW8_Tick(sender As Object, e As EventArgs) Handles ZW8.Tick

        For k = 0 To i - 1 ' Step -1
            If (die(7) = 0 And newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(7).Left And newfood(nownum(k)).Tag = 11 And zombie(7).Tag < 1) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(7).Left And newfood(nownum(k)).Tag = 12 And zombie(7).Tag < 2) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(7).Left And newfood(nownum(k)).Tag = 13 And zombie(7).Tag < 3) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(7).Left And newfood(nownum(k)).Tag = 14 And zombie(7).Tag < 4) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(7).Left And newfood(nownum(k)).Tag = 15 And zombie(7).Tag < 5) Then
                zombie(7).Left = newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30
                zbloodLB(7).Left = newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30
                Z8.Enabled = False
                zombie(7).Image = My.Resources.香菇吃
                '解決FD不夠問題
                If FD(7) <> 0 Then
                    FDtag(FD(7)) = newfood(nownum(k)).Tag
                ElseIf FD(15) <> 0 Then
                    FDtag(FD(15)) = newfood(nownum(k)).Tag
                Else
                    FDtag(FD(23)) = newfood(nownum(k)).Tag
                End If
                '
                Z8eat.Enabled = True
                bang(7) = 1 '殭屍撞到
            ElseIf bang(7) = 0 And zombie(7).Left > 0 Then '沒撞過的就是<>7
                If zombie(7).Left < pic(4).Left + pic(4).Width + 30 And pic(4).Tag = 11 And zombie(7).Tag < 1 Then
                    zombie(7).Tag += 1
                End If
                If zombie(7).Left < pic(3).Left + pic(3).Width + 30 And pic(3).Tag = 12 And zombie(7).Tag < 2 Then
                    zombie(7).Tag += 1
                End If
                If zombie(7).Left < pic(2).Left + pic(2).Width + 30 And pic(2).Tag = 13 And zombie(7).Tag < 3 Then
                    zombie(7).Tag += 1
                End If
                If zombie(7).Left < pic(1).Left + pic(1).Width + 30 And pic(1).Tag = 14 And zombie(7).Tag < 4 Then
                    zombie(7).Tag += 1
                End If
                If zombie(7).Left < pic(0).Left + pic(0).Width + 30 And pic(0).Tag = 15 And zombie(7).Tag < 5 Then
                    zombie(7).Tag += 1
                End If
                If zw(7) = 0 Then
                    zombie(7).Left = zombie(7).Left - 3
                    zbloodLB(7).Left = zbloodLB(7).Left - 3
                End If
                zw(7) = 1
                If k = i - 1 Then
                    zw(7) = 0
                ...
                If zombie(7).Left <= 0 Then '碰邊界減一命
                    heart = heart - 1
                    'heartLB.Text = heart
                    zombie(7).Size = New Size(0, 0)
                    If heart = 0 Then
                        yesno = MsgBox("你輸了!請回主選單!", , "訊息")
                        'If yesno = 6 Then
                        '    Dim frm1 = New Form1
            ...
            End If
        Next
        If i = 0 And zombie(7).Left > 0 Then '解決k第一次不能跑的問題
            zombie(7).Left = zombie(7).Left - 3
            zbloodLB(7).Left = zbloodLB(7).Left - 3
            If zombie(7).Left < pic(4).Left + pic(4).Width + 30 And pic(4).Tag = 11 And zombie(7).Tag < 1 Then
                zombie(7).Tag += 1
                ...
                If PZ(bullet(nownum(k)), zombie(x)) Then
                    ...
                    ElseIf x = 1 Then
                        ...
                        ElseIf zblood(1) < 1 And die(1) <> 1 Then
                            Z2.Enabled = False
                            zombie(1).Image = My.Resources.青椒死
                            Z2eat.Enabled = False
                            die(1) = 1
                            ZD2.Enabled = True
                        End If
                    ...
                    ElseIf x = 3 Then
                        ...
                        If zblood(3) >= 1 Then
                            If (zombie(3).Tag < 1 And bullet(nownum(k)).Tag = 11) Or (zombie(3).Tag < 2 And bullet(nownum(k)).Tag = 12) Or (zombie(3).Tag < 3 And bullet(nownum(k)).Tag = 13) Or (zombie(3).Tag < 4 And bullet(nownum(k)).Tag = 14) Or (zombie(3).Tag < 5 And bullet(nownum(k)).Tag = 15) Then
                    ...
                    ElseIf x = 4 Then
                        ...
                        If zblood(4) >= 1 Then
                            If (zombie(4).Tag < 1 And bullet(nownum(k)).Tag = 21) Or (zombie(4).Tag < 2 And bullet(nownum(k)).Tag = 22) Or (zombie(4).Tag < 3 And bullet(nownum(k)).Tag = 23) Or (zombie(4).Tag < 4 And bullet(nownum(k)).Tag = 24) Or (zombie(4).Tag < 5 And bullet(nownum(k)).Tag = 25) Then
                                zblood(4) = zblood(4) - attack
                                zbloodLB(4).Text = zblood(4)
                            End If
                        ElseIf zblood(4) < 1 And die(4) <> 1 Then
                            Z5.Enabled = False
                            zombie(4).Image = My.Resources.茄子死
                            Z5eat.Enabled = False
                            die(4) = 1
                            ZD5.Enabled = True
                        End If
                    ElseIf x = 5 Then
                        ...
                        ElseIf zblood(5) < 1 And die(5) <> 1 Then
                            Z6.Enabled = False
                            zombie(5).Image = My.Resources.青椒死
                            Z6eat.Enabled = False
                            die(5) = 1
                            ZD6.Enabled = True
                        End If
                    ElseIf x = 6 Then
                        ...
                        If zblood(6) >= 1 Then
                            If (zombie(6).Tag < 1 And bullet(nownum(k)).Tag = 21) Or (zombie(6).Tag < 2 And bullet(nownum(k)).Tag = 22) Or (zombie(6).Tag < 3 And bullet(nownum(k)).Tag = 23) Or (zombie(6).Tag < 4 And bullet(nownum(k)).Tag = 24) Or (zombie(6).Tag < 5 And bullet(nownum(k)).Tag = 25) Then
                                zblood(6) = zblood(6) - attack
                                zbloodLB(6).Text = zblood(6)
                            End If
                        ElseIf zblood(6) < 1 And die(6) <> 1 Then
                            Z7.Enabled = False
                            zombie(6).Image = My.Resources.青椒死
                            Z6eat.Enabled = False
                            die(6) = 1
                            ZD7.Enabled = True
                        End If
                    ElseIf x = 7 Then
                        ...
                        If zblood(7) >= 1 Then
                            If (zombie(7).Tag < 1 And bullet(nownum(k)).Tag = 11) Or (zombie(7).Tag < 2 And bullet(nownum(k)).Tag = 12) Or (zombie(7).Tag < 3 And bullet(nownum(k)).Tag = 13) Or (zombie(7).Tag < 4 And bullet(nownum(k)).Tag = 14) Or (zombie(7).Tag < 5 And bullet(nownum(k)).Tag = 15) Then
                                zblood(7) = zblood(7) - attack
                                zbloodLB(7).Text = zblood(7)
                            End If
                        ElseIf zblood(7) < 1 And die(7) <> 1 Then
                            Z8.Enabled = False
                            zombie(7).Image = My.Resources.香菇死
                            Z6eat.Enabled = False
                            die(7) = 1
                            ZD8.Enabled = True
                        End If
...
#Region "等一秒消失Timer"
    ...
    Private Sub ZD6_Tick(sender As Object, e As EventArgs) Handles ZD6.Tick '第一隻殭屍消失
        ...
        Z6eat.Enabled = False
    End Sub
    Private Sub ZD7_Tick(sender As Object, e As EventArgs) Handles ZD7.Tick '第一隻殭屍消失
        ZW7.Enabled = False
        zombie(6).Size = New Size(0, 0)
        zombie(6).Left = 801
        zbloodLB(6).Visible = False
        ZD7.Enabled = False
        Z7eat.Enabled = False
    End Sub
    Private Sub ZD8_Tick(sender As Object, e As EventArgs) Handles ZD8.Tick '第一隻殭屍消失
        ZW8.Enabled = False
        zombie(7).Size = New Size(0, 0)
        zombie(7).Left = 801
        zbloodLB(7).Visible = False
        ZD8.Enabled = False
        Z8eat.Enabled = False
    End Sub
#End Region
...
#Region "食物血量的Timer"
    Private Sub Z1eat_Tick(sender As Object, e As EventArgs) Handles Z1eat.Tick
        For y = 0 To i - 1
            If Fblood(y).Tag = FDtag(FD(0)) Or Fblood(y).Tag = FDtag(FD(8)) Or Fblood(y).Tag = FDtag(FD(16)) Then
                If Fblood(y).Text = 0 Then
                    For j = 0 To i - 1
                        If newfood(nownum(j)).Tag = FDtag(FD(0)) Or newfood(nownum(j)).Tag = FDtag(FD(8)) Or newfood(nownum(j)).Tag = FDtag(FD(16)) Then
                            ...
                            For a = 0 To 19
                                If pic(a).Tag = newfood(nownum(j)).Tag + 5 Then
                                    ...
                                    If newfood(nownum(j)).Tag = FDtag(FD(0)) Then
                                        FD(0) = FD(0) + 1
                                    ElseIf newfood(nownum(j)).Tag = FDtag(FD(8)) Then
                                        FD(8) = FD(8) + 1
                                    Else
                                        FD(16) = FD(16) + 1
                                    End If
    ...
    Private Sub Z2eat_Tick(sender As Object, e As EventArgs) Handles Z2eat.Tick
        For y = 0 To i - 1
            If Fblood(y).Tag = FDtag(FD(1)) Or Fblood(y).Tag = FDtag(FD(9)) Or Fblood(y).Tag = FDtag(FD(17)) Then
                If Fblood(y).Text = 0 Then
                    For j = 0 To i - 1
                        If newfood(nownum(j)).Tag = FDtag(FD(1)) Or newfood(nownum(j)).Tag = FDtag(FD(9)) Or newfood(nownum(j)).Tag = FDtag(FD(17)) Then
                            newfood(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Location = New Point(780, 1000)
                            bullet(nownum(j)).Visible = False
                            Z2.Enabled = True
                            'zombie(1).Image = My.Resources.青椒
                            bang(1) = 0
                            For a = 0 To 19
                                If pic(a).Tag = newfood(nownum(j)).Tag + 5 Then
                                    pic(a).Tag = pic(a).Tag - 5
                                    If Fblood(y).Tag = FDtag(FD(1)) Then
                                        FD(1) = FD(1) + 1
                                    ElseIf Fblood(y).Tag = FDtag(FD(9)) Then
                                        FD(9) = FD(9) + 1
                                    Else
                                        FD(17) = FD(17) + 1
                                    End If
    ...
    Private Sub Z3eat_Tick(sender As Object, e As EventArgs) Handles Z3eat.Tick
        For y = 0 To i - 1
            If Fblood(y).Tag = FDtag(FD(2)) Or Fblood(y).Tag = FDtag(FD(10)) Or Fblood(y).Tag = FDtag(FD(18)) Then
                If Fblood(y).Text = 0 Then
                    For j = 0 To i - 1
                        If newfood(nownum(j)).Tag = FDtag(FD(2)) Or newfood(nownum(j)).Tag = FDtag(FD(10)) Or newfood(nownum(j)).Tag = FDtag(FD(18)) Then
                            newfood(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Location = New Point(780, 1000)
                            bullet(nownum(j)).Visible = False
                            ...
                            For a = 0 To 19
                                If pic(a).Tag = newfood(nownum(j)).Tag + 5 Then
                                    ...
                                    If Fblood(y).Tag = FDtag(FD(2)) Then
                                        FD(2) = FD(2) + 1
                                    ElseIf Fblood(y).Tag = FDtag(FD(10)) Then
                                        FD(10) = FD(10) + 1
                                    Else
                                        FD(18) = FD(18) + 1
                                    End If
    ...
    Private Sub Z4eat_Tick(sender As Object, e As EventArgs) Handles Z4eat.Tick
        For y = 0 To i - 1
            If Fblood(y).Tag = FDtag(FD(3)) Or Fblood(y).Tag = FDtag(FD(11)) Or Fblood(y).Tag = FDtag(FD(19)) Then
                If Fblood(y).Text = 0 Then
                    For j = 0 To i - 1
                        If newfood(nownum(j)).Tag = FDtag(FD(3)) Or newfood(nownum(j)).Tag = FDtag(FD(11)) Or newfood(nownum(j)).Tag = FDtag(FD(19)) Then
                            newfood(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Location = New Point(780, 1000)
                            bullet(nownum(j)).Visible = False
                            ...
                            For a = 0 To 19
                                If pic(a).Tag = newfood(nownum(j)).Tag + 5 Then
                                    ...
                                    If Fblood(y).Tag = FDtag(FD(3)) Then
                                        FD(3) = FD(3) + 1
                                    ElseIf Fblood(y).Tag = FDtag(FD(11)) Then
                                        FD(11) = FD(11) + 1
                                    Else
                                        FD(19) = FD(19) + 1
                                    End If
    ...
    Private Sub Z5eat_Tick(sender As Object, e As EventArgs) Handles Z5eat.Tick
        For y = 0 To i - 1
            If Fblood(y).Tag = FDtag(FD(4)) Or Fblood(y).Tag = FDtag(FD(12)) Or Fblood(y).Tag = FDtag(FD(20)) Then
                If Fblood(y).Text = 0 Then
                    For j = 0 To i - 1
                        If newfood(nownum(j)).Tag = FDtag(FD(4)) Or newfood(nownum(j)).Tag = FDtag(FD(12)) Or newfood(nownum(j)).Tag = FDtag(FD(20)) Then
                            newfood(nownum(j)).Size = New Size(0, 0)
                            'bullet(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Location = New Point(780, 1000)
                            bullet(nownum(j)).Visible = True
                            Z5.Enabled = True
                            'zombie(4).Image = My.Resources.茄子
                            bang(4) = 0
                            For a = 0 To 19
                                If pic(a).Tag = newfood(nownum(j)).Tag + 5 Then
                                    pic(a).Tag = pic(a).Tag - 5
                                    If Fblood(y).Tag = FDtag(FD(4)) Then
                                        FD(4) = FD(4) + 1
                                    ElseIf Fblood(y).Tag = FDtag(FD(12)) Then
                                        FD(12) = FD(12) + 1
                                    Else
                                        FD(20) = FD(20) + 1
                                    End If
    ...
    Private Sub Z6eat_Tick(sender As Object, e As EventArgs) Handles Z6eat.Tick
        For y = 0 To i - 1
            If Fblood(y).Tag = FDtag(FD(5)) Or Fblood(y).Tag = FDtag(FD(13)) Or Fblood(y).Tag = FDtag(FD(21)) Then
                If Fblood(y).Text = 0 Then
                    For j = 0 To i - 1
                        If newfood(nownum(j)).Tag = FDtag(FD(5)) Or newfood(nownum(j)).Tag = FDtag(FD(13)) Or newfood(nownum(j)).Tag = FDtag(FD(21)) Then
                            newfood(nownum(j)).Size = New Size(0, 0)
                            'bullet(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Location = New Point(780, 1000)
                            bullet(nownum(j)).Visible = True
                            Z6.Enabled = True
                            'zombie(5).Image = My.Resources.青椒
                            bang(5) = 0
                            For a = 0 To 19
                                If pic(a).Tag = newfood(nownum(j)).Tag + 5 Then
                                    pic(a).Tag = pic(a).Tag - 5
                                    If Fblood(y).Tag = FDtag(FD(5)) Then
                                        FD(5) = FD(5) + 1
                                    ElseIf Fblood(y).Tag = FDtag(FD(13)) Then
                                        FD(13) = FD(13) + 1
                                    Else
                                        FD(21) = FD(21) + 1
                                    End If
    ...
    End Sub
    Private Sub Z7eat_Tick(sender As Object, e As EventArgs) Handles Z7eat.Tick
        For y = 0 To i - 1
            If Fblood(y).Tag = FDtag(FD(6)) Or Fblood(y).Tag = FDtag(FD(14)) Or Fblood(y).Tag = FDtag(FD(22)) Then
                If Fblood(y).Text = 0 Then
                    For j = 0 To i - 1
                        If newfood(nownum(j)).Tag = FDtag(FD(6)) Or newfood(nownum(j)).Tag = FDtag(FD(14)) Or newfood(nownum(j)).Tag = FDtag(FD(22)) Then
                            newfood(nownum(j)).Size = New Size(0, 0)
                            'bullet(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Location = New Point(780, 1000)
                            bullet(nownum(j)).Visible = True
                            Z7.Enabled = True
                            'zombie(6).Image = My.Resources.青椒
                            bang(6) = 0
                            For a = 0 To 19
                                If pic(a).Tag = newfood(nownum(j)).Tag + 5 Then
                                    pic(a).Tag = pic(a).Tag - 5
                                    If Fblood(y).Tag = FDtag(FD(6)) Then
                                        FD(6) = FD(6) + 1
                                    ElseIf Fblood(y).Tag = FDtag(FD(14)) Then
                                        FD(14) = FD(14) + 1
                                    Else
                                        FD(22) = FD(22) + 1
                                    End If
    ...
    End Sub
    Private Sub Z8eat_Tick(sender As Object, e As EventArgs) Handles Z8eat.Tick
        For y = 0 To i - 1
            If Fblood(y).Tag = FDtag(FD(7)) Or Fblood(y).Tag = FDtag(FD(15)) Or Fblood(y).Tag = FDtag(FD(23)) Then
                If Fblood(y).Text = 0 Then
                    For j = 0 To i - 1
                        If newfood(nownum(j)).Tag = FDtag(FD(7)) Or newfood(nownum(j)).Tag = FDtag(FD(15)) Or newfood(nownum(j)).Tag = FDtag(FD(23)) Then
                            newfood(nownum(j)).Size = New Size(0, 0)
                            'bullet(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Location = New Point(780, 1000)
                            bullet(nownum(j)).Visible = True
                            Z8.Enabled = True
                            'zombie(7).Image = My.Resources.香菇
                            bang(7) = 0
                            For a = 0 To 19
                                If pic(a).Tag = newfood(nownum(j)).Tag + 5 Then
                                    pic(a).Tag = pic(a).Tag - 5
                                    If Fblood(y).Tag = FDtag(FD(7)) Then
                                        FD(7) = FD(7) + 1
                                    ElseIf Fblood(y).Tag = FDtag(FD(15)) Then
                                        FD(15) = FD(15) + 1
                                    Else
                                        FD(23) = FD(23) + 1
                                    End If
...
#End Region
    Private Sub moneyTimer_Tick(sender As Object, e As EventArgs) Handles moneyTimer.Tick
        ...
        moneyX = Int(Rnd() * 701 + 40) 'X座標40~770
    ...
    Private Sub Z2_Tick(sender As Object, e As EventArgs) Handles Z2.Tick
        c(1) = c(1) + 1
        If c(1) > 3 Then c(1) = 1
        zombie(1).Image = Image.FromFile((Application.StartupPath & "\殭屍\青椒" & c(1) & ".png"))
    End Sub
    ...
    Private Sub Z4_Tick(sender As Object, e As EventArgs) Handles Z4.Tick
        c(3) = c(3) + 1
        If c(3) > 4 Then c(3) = 1
        zombie(3).Image = Image.FromFile((Application.StartupPath & "\殭屍\茄子" & c(3) & ".png"))
    End Sub
    Private Sub Z5_Tick(sender As Object, e As EventArgs) Handles Z5.Tick
        c(4) = c(4) + 1
        If c(4) > 4 Then c(4) = 1
        zombie(4).Image = Image.FromFile((Application.StartupPath & "\殭屍\茄子" & c(4) & ".png"))
    End Sub

    Private Sub Z6_Tick(sender As Object, e As EventArgs) Handles Z6.Tick
        c(5) = c(5) + 1
        If c(5) > 3 Then c(5) = 1
        zombie(5).Image = Image.FromFile((Application.StartupPath & "\殭屍\青椒" & c(5) & ".png"))
    End Sub
    Private Sub Z7_Tick(sender As Object, e As EventArgs) Handles Z7.Tick
        c(6) = c(6) + 1
        If c(6) > 3 Then c(6) = 1
        zombie(6).Image = Image.FromFile((Application.StartupPath & "\殭屍\青椒" & c(6) & ".png"))
    End Sub

    Private Sub Panelwin_Paint(sender As Object, e As PaintEventArgs) Handles Panelwin.Paint

    End Sub

    Private Sub Z8_Tick(sender As Object, e As EventArgs) Handles Z8.Tick
        c(7) = c(7) + 1
        If c(7) > 9 Then c(7) = 1
        zombie(7).Image = Image.FromFile((Application.StartupPath & "\殭屍\香菇" & c(7) & ".png"))
    End Sub
