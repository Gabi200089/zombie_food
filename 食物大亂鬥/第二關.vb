Public Class 第二關
    ...
    Dim t(27) As Integer 'timer陣列
    Dim win As Integer = 0
    Dim i, c(6) As Integer
    Dim Fblood(19) As Label
    Dim FDtag(19) As Integer
    Dim FD(20) As Integer
    Dim bang(6) As Integer '殭屍有沒有撞到
    ...
    Dim die(6) As Integer '已死掉
    Dim number As Integer '第幾隻殭屍要死掉
    Dim zblood(6) As Integer '殭屍血量
    Dim zbloodLB(6) As Label '殭屍血量label
    Dim pic(19) As PictureBox '選擇放置位子的框框
    Dim zombie(6) As PictureBox '殭屍
    ...
    Private Sub 第二關_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        moneyLB.Text = 50
        ...
        AxWindowsMediaPlayer1.URL = Application.StartupPath & "\sounds\gameplay2.mp3"
        Randomize()
        i = 0
...
#End Region
        ...
        For j = 0 To 6
            ...
            If j = 0 Then   '第一隻在第四排
                zombie(j).Top = 472
                zbloodLB(j).Top = 457
            ElseIf j = 1 Then   '第二隻在第二排
                zombie(j).Top = 250
                zbloodLB(j).Top = 235
            ElseIf j = 2 Then   '第三隻在第一排
                zombie(j).Top = 123
                zbloodLB(j).Top = 141
            ElseIf j = 3 Then   '第四隻在第三排
                zombie(j).Top = 357
                zbloodLB(j).Top = 342
            ElseIf j = 4 Then   '第五隻在第四排
                zombie(j).Top = 472
                zbloodLB(j).Top = 457
            ElseIf j = 5 Then   '第六隻在第二排
                zombie(j).Top = 250
                zbloodLB(j).Top = 235
            ElseIf j = 6 Then   '第七隻在第一排
                zombie(j).Top = 123
                zbloodLB(j).Top = 141
            End If
        ...
        'zombie(6).Image = My.Resources.茄子
...
#Region "殭屍前進且碰食物暫停"
    Private Sub ZW1_Tick(sender As Object, e As EventArgs) Handles ZW1.Tick
        For k = 0 To i - 1 ' Step -1
            ...
            ElseIf bang(0) = 0 And zombie(0).Left > 0 Then '沒撞過的就是<>7
                If zombie(0).Left < pic(19).Left + pic(19).Width + 30 And pic(19).Tag = 41 And zombie(0).Tag < 1 Then
                    zombie(0).Tag += 1
                End If
                If zombie(0).Left < pic(18).Left + pic(18).Width + 30 And pic(18).Tag = 42 And zombie(0).Tag < 2 Then
                    zombie(0).Tag += 1
                End If
                If zombie(0).Left < pic(17).Left + pic(17).Width + 30 And pic(17).Tag = 43 And zombie(0).Tag < 3 Then
                    zombie(0).Tag += 1
                End If
                If zombie(0).Left < pic(16).Left + pic(16).Width + 30 And pic(16).Tag = 44 And zombie(0).Tag < 4 Then
                    zombie(0).Tag += 1
                End If
                If zombie(0).Left < pic(15).Left + pic(15).Width + 30 And pic(15).Tag = 45 And zombie(0).Tag < 5 Then
                    zombie(0).Tag += 1
                End If
                If zw(0) = 0 Then
    ...
    Private Sub ZW5_Tick(sender As Object, e As EventArgs) Handles ZW5.Tick
        ...
        For k = 0 To i - 1 ' Step -1
            If (die(4) = 0 And newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(4).Left And newfood(nownum(k)).Tag = 41 And zombie(4).Tag < 1) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(4).Left And newfood(nownum(k)).Tag = 42 And zombie(4).Tag < 2) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(4).Left And newfood(nownum(k)).Tag = 43 And zombie(4).Tag < 3) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(4).Left And newfood(nownum(k)).Tag = 44 And zombie(4).Tag < 4) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(4).Left And newfood(nownum(k)).Tag = 45 And zombie(4).Tag < 5) Then
            ...
            ElseIf bang(4) = 0 And zombie(4).Left > 0 Then '沒撞過的就是<>7
                If zombie(4).Left < pic(14).Left + pic(14).Width + 30 And pic(14).Tag = 41 And zombie(4).Tag < 1 Then
                    zombie(4).Tag += 1
                End If
                If zombie(4).Left < pic(13).Left + pic(13).Width + 30 And pic(13).Tag = 42 And zombie(4).Tag < 2 Then
                    zombie(4).Tag += 1
                End If
                If zombie(4).Left < pic(12).Left + pic(12).Width + 30 And pic(12).Tag = 43 And zombie(4).Tag < 3 Then
                    zombie(4).Tag += 1
                End If
                If zombie(4).Left < pic(11).Left + pic(11).Width + 30 And pic(11).Tag = 44 And zombie(4).Tag < 4 Then
                    zombie(4).Tag += 1
                End If
                If zombie(4).Left < pic(10).Left + pic(10).Width + 30 And pic(10).Tag = 45 And zombie(4).Tag < 5 Then
                    zombie(4).Tag += 1
                End If
                If zw(4) = 0 Then
    ...
    Private Sub ZW6_Tick(sender As Object, e As EventArgs) Handles ZW6.Tick
        ...
        For k = 0 To i - 1 ' Step -1
            If (die(5) = 0 And newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(5).Left And newfood(nownum(k)).Tag = 21 And zombie(5).Tag < 1) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(5).Left And newfood(nownum(k)).Tag = 22 And zombie(5).Tag < 2) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(5).Left And newfood(nownum(k)).Tag = 23 And zombie(5).Tag < 3) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(5).Left And newfood(nownum(k)).Tag = 24 And zombie(5).Tag < 4) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(5).Left And newfood(nownum(k)).Tag = 25 And zombie(5).Tag < 5) Then
            ...
            ElseIf bang(5) = 0 And zombie(5).Left > 0 Then '沒撞過的就是<>7
                If zombie(5).Left < pic(9).Left + pic(9).Width + 30 And pic(9).Tag = 21 And zombie(5).Tag < 1 Then
                    zombie(5).Tag += 1
                End If
                If zombie(5).Left < pic(8).Left + pic(8).Width + 30 And pic(8).Tag = 22 And zombie(5).Tag < 2 Then
                    zombie(5).Tag += 1
                End If
                If zombie(5).Left < pic(7).Left + pic(7).Width + 30 And pic(7).Tag = 23 And zombie(5).Tag < 3 Then
                    zombie(5).Tag += 1
                End If
                If zombie(5).Left < pic(6).Left + pic(6).Width + 30 And pic(6).Tag = 24 And zombie(5).Tag < 4 Then
                    zombie(5).Tag += 1
                End If
                If zombie(5).Left < pic(5).Left + pic(5).Width + 30 And pic(5).Tag = 25 And zombie(5).Tag < 5 Then
                    zombie(5).Tag += 1
                End If
                If zw(5) = 0 Then
    ...
    Private Sub ZW7_Tick(sender As Object, e As EventArgs) Handles ZW7.Tick
        ...
        For k = 0 To i - 1 ' Step -1
            If (die(6) = 0 And newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(6).Left And newfood(nownum(k)).Tag = 11 And zombie(6).Tag < 1) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(6).Left And newfood(nownum(k)).Tag = 12 And zombie(6).Tag < 2) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(6).Left And newfood(nownum(k)).Tag = 13 And zombie(6).Tag < 3) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(6).Left And newfood(nownum(k)).Tag = 14 And zombie(6).Tag < 4) Or (newfood(nownum(k)).Left + newfood(nownum(k)).Width + 30 > zombie(6).Left And newfood(nownum(k)).Tag = 15 And zombie(6).Tag < 5) Then
                ...
                Z7.Enabled = False
                zombie(6).Image = My.Resources.茄子吃
                FDtag(FD(6)) = newfood(nownum(k)).Tag
                Z6eat.Enabled = True
                bang(6) = 1 '殭屍撞到
            ElseIf bang(6) = 0 And zombie(6).Left > 0 Then '沒撞過的就是<>7
                If zombie(6).Left < pic(4).Left + pic(4).Width + 30 And pic(4).Tag = 11 And zombie(6).Tag < 1 Then
                    zombie(6).Tag += 1
                End If
                If zombie(6).Left < pic(3).Left + pic(3).Width + 30 And pic(3).Tag = 12 And zombie(6).Tag < 2 Then
                    zombie(6).Tag += 1
                End If
                If zombie(6).Left < pic(2).Left + pic(2).Width + 30 And pic(2).Tag = 13 And zombie(6).Tag < 3 Then
                    zombie(6).Tag += 1
                End If
                If zombie(6).Left < pic(1).Left + pic(1).Width + 30 And pic(1).Tag = 14 And zombie(6).Tag < 4 Then
                    zombie(6).Tag += 1
                End If
                If zombie(6).Left < pic(0).Left + pic(0).Width + 30 And pic(0).Tag = 15 And zombie(6).Tag < 5 Then
                    zombie(6).Tag += 1
                End If
                If zw(6) = 0 Then
        ...
        For k = 0 To i - 1
            For x = 0 To 6
                ...
                If PZ(bullet(nownum(k)), zombie(x)) Then
                    ...
                    If x = 0 Then
                        If zblood(0) >= 1 Then
                            If (zombie(0).Tag < 1 And bullet(nownum(k)).Tag = 41) Or (zombie(0).Tag < 2 And bullet(nownum(k)).Tag = 42) Or (zombie(0).Tag < 3 And bullet(nownum(k)).Tag = 43) Or (zombie(0).Tag < 4 And bullet(nownum(k)).Tag = 44) Or (zombie(0).Tag < 5 And bullet(nownum(k)).Tag = 45) Then
                    ...
                    ElseIf x = 4 Then
                        ...
                        If zblood(4) >= 1 Then
                            If (zombie(4).Tag < 1 And bullet(nownum(k)).Tag = 41) Or (zombie(4).Tag < 2 And bullet(nownum(k)).Tag = 42) Or (zombie(4).Tag < 3 And bullet(nownum(k)).Tag = 43) Or (zombie(4).Tag < 4 And bullet(nownum(k)).Tag = 44) Or (zombie(4).Tag < 5 And bullet(nownum(k)).Tag = 45) Then
                    ...
                    ElseIf x = 5 Then
                        ...
                        If zblood(5) >= 1 Then
                            If (zombie(5).Tag < 1 And bullet(nownum(k)).Tag = 21) Or (zombie(5).Tag < 2 And bullet(nownum(k)).Tag = 22) Or (zombie(5).Tag < 3 And bullet(nownum(k)).Tag = 23) Or (zombie(5).Tag < 4 And bullet(nownum(k)).Tag = 24) Or (zombie(5).Tag < 5 And bullet(nownum(k)).Tag = 25) Then
                    ...
                    ElseIf x = 6 Then
                        If zblood(6) >= 1 Then
                            If (zombie(6).Tag < 1 And bullet(nownum(k)).Tag = 11) Or (zombie(6).Tag < 2 And bullet(nownum(k)).Tag = 12) Or (zombie(6).Tag < 3 And bullet(nownum(k)).Tag = 13) Or (zombie(6).Tag < 4 And bullet(nownum(k)).Tag = 14) Or (zombie(6).Tag < 5 And bullet(nownum(k)).Tag = 15) Then
                                zblood(6) = zblood(6) - attack
                                zbloodLB(6).Text = zblood(6)
                            End If
                        ElseIf zblood(6) < 1 And die(6) <> 1 Then
                            Z7.Enabled = False
                            zombie(6).Image = My.Resources.茄子死
                            Z7eat.Enabled = False
                            die(6) = 1
                            ZD7.Enabled = True
                        End If
...
#Region "等一秒消失Timer"
    ...
    Private Sub ZD4_Tick(sender As Object, e As EventArgs) Handles ZD4.Tick '第四隻殭屍消失
        ...
        ZW4.Enabled = False
    End Sub
    Private Sub ZD5_Tick(sender As Object, e As EventArgs) Handles ZD5.Tick '第五隻殭屍消失
        ZW5.Enabled = False
        zombie(4).Size = New Size(0, 0)
        zombie(4).Left = 801
        ...
        Z5eat.Enabled = False
    End Sub
    Private Sub ZD6_Tick(sender As Object, e As EventArgs) Handles ZD6.Tick '第六隻殭屍消失
        ZW6.Enabled = False
        zombie(5).Size = New Size(0, 0)
        zombie(5).Left = 801
        ...
        Z6eat.Enabled = False
    End Sub
    Private Sub ZD7_Tick(sender As Object, e As EventArgs) Handles ZD7.Tick '第七隻殭屍消失
        zombie(6).Size = New Size(0, 0)
        zombie(6).Left = 801
...
#Region "食物血量的Timer"
    Private Sub Z1eat_Tick(sender As Object, e As EventArgs) Handles Z1eat.Tick
        For y = 0 To i - 1
            If Fblood(y).Tag = FDtag(FD(0)) Or Fblood(y).Tag = FDtag(FD(7)) Or Fblood(y).Tag = FDtag(FD(14)) Then
                If Fblood(y).Text = 0 Then
                    For j = 0 To i - 1
                        If newfood(nownum(j)).Tag = FDtag(FD(0)) Or newfood(nownum(j)).Tag = FDtag(FD(7)) Or newfood(nownum(j)).Tag = FDtag(FD(14)) Then
                            ...
                            For a = 0 To 19
                                If pic(a).Tag = newfood(nownum(j)).Tag + 5 Then
                                    ...
                                    If newfood(nownum(j)).Tag = FDtag(FD(0)) Then
                                        FD(0) = FD(0) + 1
                                    ElseIf newfood(nownum(j)).Tag = FDtag(FD(7)) Then
                                        FD(7) = FD(7) + 1
                                    Else
                                        FD(14) = FD(14) + 1
                                    End If
    ...
    Private Sub Z2eat_Tick(sender As Object, e As EventArgs) Handles Z2eat.Tick
        For y = 0 To i - 1
            If Fblood(y).Tag = FDtag(FD(1)) Or Fblood(y).Tag = FDtag(FD(8)) Or Fblood(y).Tag = FDtag(FD(15)) Then
                If Fblood(y).Text = 0 Then
                    For j = 0 To i - 1
                        If newfood(nownum(j)).Tag = FDtag(FD(1)) Or newfood(nownum(j)).Tag = FDtag(FD(8)) Or newfood(nownum(j)).Tag = FDtag(FD(15)) Then
                            newfood(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Location = New Point(780, 1000)
                            ...
                            For a = 0 To 19
                                If pic(a).Tag = newfood(nownum(j)).Tag + 5 Then
                                    ...
                                    If Fblood(y).Tag = FDtag(FD(1)) Then
                                        FD(1) = FD(1) + 1
                                    ElseIf Fblood(y).Tag = FDtag(FD(8)) Then
                                        FD(8) = FD(8) + 1
                                    Else
                                        FD(15) = FD(15) + 1
                                    End If
    ...
    Private Sub Z3eat_Tick(sender As Object, e As EventArgs) Handles Z3eat.Tick
        For y = 0 To i - 1
            If Fblood(y).Tag = FDtag(FD(2)) Or Fblood(y).Tag = FDtag(FD(9)) Or Fblood(y).Tag = FDtag(FD(16)) Then
                If Fblood(y).Text = 0 Then
                    For j = 0 To i - 1
                        If newfood(nownum(j)).Tag = FDtag(FD(2)) Or newfood(nownum(j)).Tag = FDtag(FD(9)) Or newfood(nownum(j)).Tag = FDtag(FD(16)) Then
                            newfood(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Location = New Point(780, 1000)
                            bullet(nownum(j)).Visible = False
    ...
    Private Sub Z4eat_Tick(sender As Object, e As EventArgs) Handles Z4eat.Tick
        For y = 0 To i - 1
            If Fblood(y).Tag = FDtag(FD(3)) Or Fblood(y).Tag = FDtag(FD(10)) Or Fblood(y).Tag = FDtag(FD(17)) Then
                If Fblood(y).Text = 0 Then
                    For j = 0 To i - 1
                        If newfood(nownum(j)).Tag = FDtag(FD(3)) Or newfood(nownum(j)).Tag = FDtag(FD(10)) Or newfood(nownum(j)).Tag = FDtag(FD(17)) Then
                            newfood(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Location = New Point(780, 1000)
                            bullet(nownum(j)).Visible = False
    ...
    Private Sub Z5eat_Tick(sender As Object, e As EventArgs) Handles Z5eat.Tick
        For y = 0 To i - 1
            If Fblood(y).Tag = FDtag(FD(4)) Or Fblood(y).Tag = FDtag(FD(11)) Or Fblood(y).Tag = FDtag(FD(18)) Then
                If Fblood(y).Text = 0 Then
                    For j = 0 To i - 1
                        If newfood(nownum(j)).Tag = FDtag(FD(4)) Or newfood(nownum(j)).Tag = FDtag(FD(11)) Or newfood(nownum(j)).Tag = FDtag(FD(18)) Then
                            newfood(nownum(j)).Size = New Size(0, 0)
                            'bullet(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Location = New Point(780, 1000)
                            bullet(nownum(j)).Visible = False
    ...
    Private Sub Z6eat_Tick(sender As Object, e As EventArgs) Handles Z6eat.Tick
        For y = 0 To i - 1
            If Fblood(y).Tag = FDtag(FD(5)) Or Fblood(y).Tag = FDtag(FD(12)) Or Fblood(y).Tag = FDtag(FD(19)) Then
                If Fblood(y).Text = 0 Then
                    For j = 0 To i - 1
                        If newfood(nownum(j)).Tag = FDtag(FD(5)) Or newfood(nownum(j)).Tag = FDtag(FD(12)) Or newfood(nownum(j)).Tag = FDtag(FD(19)) Then
                            newfood(nownum(j)).Size = New Size(0, 0)
                            'bullet(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Location = New Point(780, 1000)
                            bullet(nownum(j)).Visible = False
    ...
    Private Sub Z7eat_Tick(sender As Object, e As EventArgs) Handles Z7eat.Tick
        For y = 0 To i - 1
            If Fblood(y).Tag = FDtag(FD(6)) Or Fblood(y).Tag = FDtag(FD(13)) Or Fblood(y).Tag = FDtag(FD(20)) Then
                If Fblood(y).Text = 0 Then
                    For j = 0 To i - 1
                        If newfood(nownum(j)).Tag = FDtag(FD(6)) Or newfood(nownum(j)).Tag = FDtag(FD(13)) Or newfood(nownum(j)).Tag = FDtag(FD(20)) Then
                            newfood(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Size = New Size(0, 0)
                            bullet(nownum(j)).Location = New Point(780, 1000)
                            bullet(nownum(j)).Visible = False
...
#End Region
    ...
    Private Sub Z2_Tick(sender As Object, e As EventArgs) Handles Z2.Tick
        c(1) = c(1) + 1
        If c(1) > 4 Then c(1) = 1
        zombie(1).Image = Image.FromFile((Application.StartupPath & "\殭屍\茄子" & c(1) & ".png"))
    End Sub
    ...
    Private Sub Z7_Tick(sender As Object, e As EventArgs) Handles Z7.Tick
        c(6) = c(6) + 1
        If c(6) > 4 Then c(6) = 1
        zombie(6).Image = Image.FromFile((Application.StartupPath & "\殭屍\茄子" & c(6) & ".png"))
    End Sub
    ...
    Private Sub Pausepanel_Paint(sender As Object, e As PaintEventArgs) Handles Pausepanel.Paint
